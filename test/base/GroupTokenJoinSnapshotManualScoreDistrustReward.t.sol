...
contract GroupTokenJoinSnapshotManualScoreDistrustRewardTest is BaseGroupTest {
    ...
    function setupGroupWithScores(
        ...
        vm.prank(owner);
        rewardContract.submitOriginScore(groupId, scores);
    }
    ...
    function test_RewardByGroupId_MultipleGroups() public {
        ...
        rewardContract.submitOriginScore(groupId1, scores1);

        uint256[] memory scores2 = new uint256[](1);
        scores2[0] = 80;
        vm.prank(groupOwner2);
        rewardContract.submitOriginScore(groupId2, scores2);
    ...
    function test_CalculateRewardByAccount() public {
        ...
        vm.prank(groupOwner1);
        rewardContract.submitOriginScore(groupId1, scores);
    ...
    function test_RewardDistribution_WithDistrust() public {
        ...
        vm.prank(groupOwner2);
        rewardContract.submitOriginScore(groupId2, scores);
