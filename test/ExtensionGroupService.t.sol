 ...
 */
contract ExtensionGroupServiceTest is
    BaseGroupTest,
    IGroupServiceEvents,
    IGroupRecipientsEvents
{
    ...
    ExtensionGroupServiceFactory public serviceFactory;
    ...
    function setUp() public virtual {
        ...
        // Deploy GroupService via factory (factory provides GROUP_RECIPIENTS_ADDRESS)
    ...
    function test_SetRecipients_Success() public {
        ...
        (address[] memory addrs, uint256[] memory points, ) = groupRecipients
            .recipients(
                groupOwner1,
                address(token),
                ACTION_ID,
    ...
    function test_SetRecipients_RevertNotGroupOwner() public {
        ...
        ratios[0] = 5e17;
        string[] memory remarks = new string[](1);
    ...
    function test_SetRecipients_RevertTooManyRecipients() public {
        ...
        string[] memory remarks = new string[](MAX_RECIPIENTS + 1);
    ...
    function test_Recipients_HistoryByRound() public {
        ...
        ratios1[0] = 3e17;
        string[] memory remarks1 = new string[](1);
        ...
        (address[] memory addrs1, uint256[] memory points1, ) = groupRecipients
            .recipients(
                groupOwner1,
                address(token),
                ACTION_ID,
        ...
        (address[] memory addrs2, uint256[] memory points2, ) = groupRecipients
            .recipients(
                groupOwner1,
                address(token),
                ACTION_ID,
    ...
    function test_MultipleGroupOwners() public {
        ...
        (address[] memory addrs1, , ) = groupRecipients.recipients(
            groupOwner1,
            address(token),
            ACTION_ID,
            groupId1,
        ...
        (address[] memory addrs2, , ) = groupRecipients.recipients(
            groupOwner2,
            address(token),
            ACTION_ID,
            groupId2,
    ...
    function test_EmptyRecipients() public {
        ...
        string[] memory remarks = new string[](0);
    ...
    function test_DifferentGroupsDifferentRecipients() public {
        ...
        uint256 round = verify.currentRound();
        string[] memory remarks1 = new string[](1);
        string[] memory remarks3 = new string[](1);
        vm.prank(groupOwner1);
        groupRecipients.setRecipients(
            address(token),
            ACTION_ID,
        ...
        (addrs, points, ) = groupRecipients.recipients(
            groupOwner1,
            address(token),
            ACTION_ID,
            groupId3,
        ...
        assertEq(addrs[0], address(0x300));
        assertEq(points[0], 5e17);
    }
...
contract ExtensionGroupServiceStakeTokenTest is BaseGroupTest {
        ...
        )
    {
        ...
        // Deploy GroupService via factory
        token.approve(address(serviceFactory), type(uint256).max);
        address groupServiceAddress = serviceFactory.createExtension(
            address(token),
            address(token),
