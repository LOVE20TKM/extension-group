...
contract GroupJoinTest is BaseGroupTest, IGroupJoinEvents {
        ...
        public
    {
        ...
        (bool found0, uint256 index0) = groupJoin.accountIndexByGroupId(
            address(groupAction),
            groupId1,
            users[0],
            round
        ...
        (bool foundNonMember, ) = groupJoin.accountIndexByGroupId(
            address(groupAction),
            groupId1,
            nonMember,
            round
    ...
    function test_joinInfoByRound_AtJoinRound_ReturnsCorrectValues() public {
        ...
        (
            ...
            uint256 groupId,
            address provider
        ) = groupJoin.joinInfo(address(groupAction), r, user1);
    ...
    function test_joinInfoByRound_AfterIncrease_JoinedRoundUnchanged() public {
        ...
        (uint256 joinedRound1, uint256 amount1, , ) = groupJoin.joinInfo(
            address(groupAction),
            r1,
            user1
        );
        ...
        (uint256 joinedRound2, uint256 amount2, , ) = groupJoin.joinInfo(
            address(groupAction),
            r2,
            user1
        );
    ...
    function test_joinInfoByRound_BeforeJoin_ReturnsZeros() public {
        ...
        (uint256 joinedRound, uint256 amount, uint256 groupId, ) = groupJoin
            .joinInfo(address(groupAction), r, user1);
        ...
        (joinedRound, amount, groupId, ) = groupJoin.joinInfo(
            address(groupAction),
            r,
            user1
        );
    ...
    function test_joinInfoByRound_AfterExit_ReturnsZerosAtLaterRound() public {
        ...
        (uint256 joinedRound2, uint256 amount2, uint256 gIdAtR2, ) = groupJoin
            .joinInfo(address(groupAction), r2, user1);
        ...
        ) = groupJoin.joinInfo(address(groupAction), r1, user1);
    ...
    function test_roundHistory_JoinAndIncreaseAmount_TracksCorrectly() public {
        ...
        assertEq(
            groupJoin.joinedAmountByAccount(
                address(groupAction),
                expectedRound1,
                user1
            ),
        ...
        assertEq(
            groupJoin.joinedAmount(address(groupAction), expectedRound1),
            expectedAmountRound1,
            "total joined should match in round1"
        );
        assertEq(
            groupJoin.joinedAmount(address(groupAction), expectedRound2),
            expectedAmountRound2,
    ...
    function test_roundHistory_ExitUpdates_TracksCorrectly() public {
        ...
        assertEq(
            groupJoin.joinedAmount(address(groupAction), expectedRound3),
            expectedAmountRound3,
    ...
    function test_joinAndExit_InSameRound_StateCorrect() public {
        ...
        (uint256 joinedRound, uint256 amount, uint256 groupId, ) = groupJoin
            .joinInfo(address(groupAction), join.currentRound(), user1);
    ...
    function test_queryHistoricalData_AtRound0_ReturnsZero() public view {
        ...
        assertEq(
            groupJoin.joinedAmount(address(groupAction), round0),
        ...
        assertEq(
            ...
            "accountsByGroupIdCount at round 0 should be 0"
        );

        assertEq(
            groupJoin.groupIdByAccount(address(groupAction), round0, user1),
